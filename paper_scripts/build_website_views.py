...
<div style="background: #f8fafc; padding: 16px 22px; border-radius: 10px; border: 1px solid #cbd5e1; margin-top: 12px; margin-bottom: 24px;">
  <p style="font-size: 1.1rem; margin-bottom: 6px; color: #0f172a;">
    👨‍🔬 <strong>César Rênno-Costa</strong> &amp; <strong>László</strong>
  </p>
...
@article{{rennocosta2026multielo,
  ...
  author={{R{{\^e}}nno-Costa, C{{\'e}}sar and L{{\'a}}szl{{\'o}}}},
